...
public class PaymentManager implements PaymentService {
    ...
    public void processRentalPayment(CreateRentalPaymentRequest request) {
        chechkIfPaymentIsValid(request);
        Payment payment = repository.findByCardNumber(request.getCardNumber()); //birpaymentgetirdik
    ...
    private void chechkIfPaymentIsValid(CreateRentalPaymentRequest request) {
