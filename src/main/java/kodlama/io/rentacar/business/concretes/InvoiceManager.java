...
public class InvoiceManager implements InvoiceService {
   ...
   /*@Override
    public void deleteByRentalId(int rentalId) {
        repository.deleteByRentalId(rentalId);
    }*/
    ...
    private void checkIfInvoiceExists(int id) {
        if (!repository.existsById(id)) throw new RuntimeException("Fatura bilgisi bulunamadı!");
    }
}
